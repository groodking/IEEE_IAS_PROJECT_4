...
let intro=['Here is your link: <a href="https://google.com" style="text-decoration:none;">Click here</a>']
...
function chatbotvoice(message){
    ...
    speech.text = "Sorry,I couldn't Understand";
    ...
    if(message.includes('Thanks.' || 'Thank you so much.')){
